...
if __name__ == '__main__':
    ...
    #for i in range(len(test_set)):
        ...
        mol_list_manipulate = reconstruct_ddim(h_node_pert, pos_pert, batch_node, h_halfedge_pert, halfedge_index, batch_halfedge, c_new, start_step=args.start_step)
    ...
    save_name = f'property-{args.name}_{args.task}_cddim-opt-{args.start_step}'
    if args.delta:
        save_name += '-delta'
