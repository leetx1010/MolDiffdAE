...
def reconstruct_from_generated_with_edges(mol_info, check_validity=True, add_edge=None):
    ...
    if check_validity:
        ...
        try:
            ...
            #raise MolReconsError()
            return None # TXL: use return to enable multiprocess error handling
...
##### process raw sampling outputs
def process_sampling_outputs(outputs, batch_node_raw, halfedge_index_raw, batch_halfedge_raw, featurizer):
