...
class QVinaDockingTask(BaseDockingTask):
    ...
    @classmethod
    def from_generated_mol(cls, ligand_rdmol, ligand_filename, protein_root='./data/crossdocked', task_id=None, **kwargs):
        # load original pdb
        protein_fn = os.path.join(
        ...
        with open(protein_path, 'r') as f:
            pdb_block = f.read()
        return cls(pdb_block, ligand_rdmol, task_id=task_id, **kwargs)
